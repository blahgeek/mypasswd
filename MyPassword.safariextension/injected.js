function wrapper(){
    ...
    window.mypasswd = function(passwd, domain){
        var t = function(s){
            for(var i = 0 ; i < 10 ; i ++){
        ...
        console.log(ret_lines);
    };
}

var script = document.createElement('script'),
    code   = document.createTextNode('(' + wrapper + ')();');
